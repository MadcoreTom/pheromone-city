...
async function start() {
    ...
    ALL_TOOLS.filter(t => t.name === "House")[0].onClick(state, 3, 2);
    ALL_TOOLS.filter(t => t.name === "House")[0].onClick(state, 9, 4);
    ALL_TOOLS.filter(t => t.name === "House")[0].onClick(state, 2, 9);
